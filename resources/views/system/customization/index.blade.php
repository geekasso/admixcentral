                ...
                <div class="card-modern">
                    ...
                    <div class="card-body-modern grid grid-cols-1 md:grid-cols-2 gap-6 space-y-0">
                        ...
                        <div class="col-span-1">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Custom Logo
                                (Top Left)</label>
                            <div
                ...
                <div class="card-modern">
                    ...
                    <div class="card-body-modern">
                        ...
                        <div class="pt-6 border-t border-gray-200 dark:border-gray-700">
                            <h4 class="text-base font-medium text-gray-900 dark:text-gray-100 mb-4">Sidebar Appearance
                                (White Labeling)</h4>

                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                <div class="space-y-4">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Background
                                        Color</label>
                                    <div class="flex items-center gap-3">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Click Auto to pick the best
                                ...
                                <div class="lg:col-span-1">
                                    <div class="flex justify-between items-center mb-2">
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Live
                                            Preview</label>
                ...
                <div class="card-modern" x-data="sslInstaller()">
                    <div class="card-header-modern">
                        ...
                        <div>
                            ...
                            <p class="card-subtitle-modern">Manage your primary application URL and security settings.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card-body-modern">
                        <div class="grid grid-cols-1 gap-8">
                            <!-- Hostname & Protocol -->
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Primary
                                    Site URL</label>
                                <div
                                    ...
                                    <div class="flex-shrink-0">
                                        <button type="button" id="verifyDomainBtn" onclick="verifyReachabilityOnly()"
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="ml-3 flex-1 md:flex md:justify-between">
                                            <p class="text-sm text-yellow-700 dark:text-yellow-300">
                                                ...
                                                Admix Central recommends using HTTPS. You can automatically provision a free
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">Update frequency when connected to WebSocket.
                                    </p>
                                </div>
                            </div>
                            <!-- Fallback -->
