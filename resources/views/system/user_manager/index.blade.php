                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    @if($tab === 'users')
                        <div class="flex justify-end mb-4">
                            <a href="{{ route('system.user_manager.users.create', $firewall->id) }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">
                                Add User
                            </a>
                        </div>
                    ...
                    @elseif($tab === 'groups')
                        <div class="flex justify-end mb-4">
                            <a href="{{ route('system.user_manager.groups.create', $firewall->id) }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">
                                Add Group
                            </a>
                        </div>
                        <div class="overflow-x-auto">
