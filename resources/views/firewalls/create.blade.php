            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('firewalls.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="name" class="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-300">Firewall Name</label>
                        ...
                        <div class="mb-4">
                            <label for="url" class="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-300">URL</label>
                        ...
                        <div x-data="{ authMethod: '{{ old('auth_method', 'basic') }}' }">
                            <div class="mb-4">
                                <label for="auth_method" class="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-300">Authentication
                                    Method</label>
                            ...
                            <div x-show="authMethod === 'basic'">
                                <div class="mb-4">
                                    <label for="api_key" class="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-300">API Username</label>
                                ...
                                <div class="mb-4">
                                    <label for="api_secret" class="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-300">API Password</label>
                            ...
                            <div x-show="authMethod === 'token'">
                                <div class="mb-4">
                                    <label for="api_token" class="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-300">API Token</label>
                        ...
                        <div class="mb-4">
                            <label for="description" class="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-300">Description
                                (Optional)</label>
